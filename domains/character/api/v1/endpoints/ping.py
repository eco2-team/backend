...
Usage:
    curl -H "Authorization: Bearer <token>" https://api.dev.growbin.app/api/v1/character/ping
"""

from fastapi import APIRouter, Depends

from domains.character.api.dependencies import get_current_user, UserInfo
