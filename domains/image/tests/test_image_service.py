...
from domains.image.core.config import Settings  # noqa: E402
from domains.image.schemas.image import ImageChannel, ImageUploadRequest  # noqa: E402
from domains.image.services.image import (  # noqa: E402
    ImageService,
    PendingUpload,
...
class TestFinalizeUpload:
    ...
    async def test_finalizes_upload(self, service, mock_redis):
        """업로드를 완료합니다."""
        from domains.image.schemas.image import ImageUploadCallbackRequest
