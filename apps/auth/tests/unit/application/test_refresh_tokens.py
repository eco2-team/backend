...
class TestRefreshTokensInteractor:
    ...
    @pytest.fixture
    def mock_token_session_store(self) -> AsyncMock:
        store = AsyncMock()
    ...
    async def test_refresh_success(
        ...
        """정상적인 토큰 갱신 테스트."""
        # Arrange
        mock_token_issuer.decode.return_value = valid_refresh_payload
        ...
        # 새 토큰 저장 확인
        mock_token_session_store.register.assert_called_once()
    ...
    async def test_refresh_token_not_in_store(
        ...
        # Arrange
        mock_token_issuer.decode.return_value = valid_refresh_payload
        mock_token_session_store.contains.return_value = False  # 스토어에 없음
