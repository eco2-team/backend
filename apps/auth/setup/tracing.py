"""OpenTelemetry Distributed Tracing Configuration for Auth API.
...
Architecture:
  Auth API (OTel SDK) -> OTLP/HTTP (4318) -> Jaeger Collector
"""
...
def instrument_httpx() -> None:
    """HTTPX 자동 계측 (OAuth provider 호출 추적)."""
    if not OTEL_ENABLED:
        return
