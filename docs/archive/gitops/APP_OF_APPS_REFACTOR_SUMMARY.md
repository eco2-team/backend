...
| 40 | Monitoring | `charts/observability/kube-prometheus-stack` | Prometheus, Grafana |
| 50 | Data Operators | `k8s/data-operators/` | PostgreSQL, Redis, RabbitMQ Operators |
| 60 | Data Clusters | `charts/data/databases` | Database Instances |
| 70 | GitOps Tools | `charts/platform/atlantis` | Atlantis |
