...
kubectl exec -it $(kubectl get pod -l app.sesacthon.io/name=storage-worker -o jsonpath='{.items[0].metadata.name}') -- bash
...
### 모니터링
- [docs/deployment/platform/MONITORING_SETUP.md](../docs/deployment/platform/MONITORING_SETUP.md)
