...
flowchart TD
    ...
    style B fill:#ffd1d1,stroke:#dc3545,stroke-width:2px,color:#000
    style C fill:#ffd1d1,stroke:#dc3545,stroke-width:2px,color:#000
    style D fill:#ffd1d1,stroke:#dc3545,stroke-width:2px,color:#000
    style E fill:#d1f2eb,stroke:#28a745,stroke-width:3px,color:#000
    style F1 fill:#ffe0b3,stroke:#fd7e14,stroke-width:2px,color:#000
    style F2 fill:#cce5ff,stroke:#007bff,stroke-width:2px,color:#000
    style F3 fill:#ccf5f0,stroke:#20c997,stroke-width:2px,color:#000
    style F4 fill:#ffd1d1,stroke:#dc3545,stroke-width:2px,color:#000
```
...
flowchart TD
    ...
    style A fill:#cce5ff,stroke:#007bff,stroke-width:4px,color:#000
    style B fill:#ffd1d1,stroke:#dc3545,stroke-width:2px,color:#000
    style B1 fill:#ffd1d1,stroke:#dc3545,stroke-width:2px,color:#000
    style B2 fill:#ffd1d1,stroke:#dc3545,stroke-width:2px,color:#000
    style B3 fill:#ffd1d1,stroke:#dc3545,stroke-width:2px,color:#000
    style B4 fill:#ffd1d1,stroke:#dc3545,stroke-width:2px,color:#000
    style C fill:#ffe0b3,stroke:#fd7e14,stroke-width:2px,color:#000
    style C1 fill:#ffe0b3,stroke:#fd7e14,stroke-width:2px,color:#000
    style D fill:#d1f2eb,stroke:#28a745,stroke-width:3px,color:#000
    style D1 fill:#d1f2eb,stroke:#28a745,stroke-width:3px,color:#000
    style D2 fill:#d1f2eb,stroke:#28a745,stroke-width:3px,color:#000
```
