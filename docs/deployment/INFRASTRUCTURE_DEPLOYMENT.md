...
- [GITOPS_BEST_PRACTICES.md](docs/architecture/GITOPS_BEST_PRACTICES.md)
- [KUSTOMIZE_APP_OF_APPS.md](docs/architecture/KUSTOMIZE_APP_OF_APPS.md)
- [Atlantis Setup Guide](docs/deployment/ATLANTIS_SETUP.md)
