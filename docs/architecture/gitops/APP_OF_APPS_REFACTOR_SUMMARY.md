...
├── 50-data-operators.yaml       # Wave 50
├── 60-data-clusters.yaml        # Wave 60
├── 70-gitops-tools.yaml         # Wave 70
├── 80-apis-app-of-apps.yaml     # Wave 80 (Nested App of Apps)
│
└── apis/                        # API 개별 파일들
...
|------|------------|------|------|
| -1 | Namespaces | `k8s/namespaces/` | Namespaces |
| 0 | Infrastructure | `k8s/infrastructure/` | Namespaces, NetworkPolicies |
| 20 | AWS Load Balancer Controller | Helm `eks/aws-load-balancer-controller` | 외부 Chart |
| 30 | Platform | `k8s/platform/` | Node Lifecycle, External Secrets (Reserved) |
| 40 | Monitoring | `platform/helm/observability/kube-prometheus-stack` | Prometheus, Grafana |
| 50 | Data Operators | `k8s/data-operators/` | PostgreSQL, Redis, RabbitMQ Operators |
| 60 | Data Clusters | `platform/helm/data/databases` | Database Instances |
| 70 | GitOps Tools | `platform/helm/platform/atlantis` | Atlantis |
| 80 | APIs App of Apps | `argocd/apps/apis/` | Nested App of Apps |
...
- **설계 문서**: `docs/architecture/gitops/KUSTOMIZE_APP_OF_APPS.md`
- **GitOps 가이드**: `docs/architecture/gitops/GITOPS_BEST_PRACTICES.md`
