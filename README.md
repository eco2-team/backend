...
**이코에코(Eco²)**는 AI 캐릭터 이코(Eco)와 함께 올바른 분리배출을 재미있게 실천할 수 있도록 돕는 AI 기반의 분리수거 안내 앱입니다. <br>
단순히 폐기물 인식 정보를 제공하는 것을 넘어 사용자의 참여율과 분리배출 정확도를 동시에 높이는 생활밀착형 행동 코칭 서비스를 지향합니다. <br>
