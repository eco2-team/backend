...
from domain.auth.services.auth import ACCESS_COOKIE_NAME
from domain.auth.services.token_blacklist import TokenBlacklist
from domain._shared.security import build_access_token_dependency
...
from domain.auth.api.v1.endpoints import auth as _auth_endpoints  # noqa: F401, E402, UP035
from domain.auth.api.v1.endpoints import health as _health_endpoints  # noqa: F401, E402, UP035
from domain.auth.api.v1.endpoints import metrics as _metrics_endpoints  # noqa: F401, E402, UP035
...
# health_router는 api_router에 포함하지 않음 - main.py에서 직접 마운트
