...
```python
# domain/auth/repositories/user_repository.py
...
- `domain/auth/services/providers/google.py` - Google OAuth 구현
- `domain/auth/services/providers/naver.py` - Naver OAuth 구현
- `domain/auth/services/providers/kakao.py` - Kakao OAuth 구현
- `domain/auth/repositories/user_repository.py` - 사용자 저장 로직
- `domain/auth/models/user.py` - User 모델 정의
- `domain/auth/schemas/oauth.py` - OAuthProfile 스키마
